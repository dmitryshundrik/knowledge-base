...
public interface FilmRepository extends JpaRepository<Film, UUID> {
    ...
    @Query("SELECT new com.dmitryshundrik.knowledgebase.dto.cinema.FilmArchiveDto(film.created, film.slug, film.title, " +
    ...
    @Query("SELECT new com.dmitryshundrik.knowledgebase.dto.cinema.FilmResponseDto(film.slug, film.title, film.director, film.starring, " +
