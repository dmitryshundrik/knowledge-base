...
INSERT INTO musicians (id, slug, first_name, last_name, nick_name, birth_date, "period", image)
VALUES ('112C8DD8-346B-426E-B06C-01BBA97DCD00', 'cardi-b', 'Belcalis Marlenis', 'Almánzar', 'Cardi B', '1992-10-11',
        'XXI_CENTURY_MUSIC', '/images/cardi-b-img.png'),
       ('112C8DD8-346B-426E-B06C-01BA97DCD601', 'perfume-genius', 'Michael Alden', 'Hadreas', 'Perfume Genius','1981-09-25',
        'XXI_CENTURY_MUSIC', '/images/cardi-b-img.png'),
       ('112C8DD8-346B-426E-B06C-01BBA97DCD02', 'the-chicks', 'none', 'none', 'The Chicks', '2020-01-01',
        'XXI_CENTURY_MUSIC', '/images/cardi-b-img.png'),
       ('112C8DD8-346B-426E-B06C-01BBA97DCD03', 'adrianne-lenker', 'Adrianne', 'Lenker', 'Adrianne Lenker','2020-01-01',
        'XXI_CENTURY_MUSIC', '/images/cardi-b-img.png'),
       ('112C8DD8-346B-426E-B06C-01BBA97DCD04', 'arca', 'none', 'none', 'Arca', '2020-01-01',
        'XXI_CENTURY_MUSIC', '../images/cardi-b-img.png'),
       ('112C8DD8-346B-426E-B06C-01BBA97DCD05', 'kelly-lee-owens', 'Kelly', 'Lee-Owens', 'Kelly Lee Owens', '2020-01-01',
        'XXI_CENTURY_MUSIC', '../images/cardi-b-img.png'),
       ('112C8DD8-346B-426E-B06C-01BBA97DCD06', 'jessie-ware', 'Jessie', 'Ware', 'Jessie Ware', '2020-01-01',
        'XXI_CENTURY_MUSIC', '../images/cardi-b-img.png'),
       ('112C8DD8-346B-426E-B06C-01BBA97DCD07', 'phoebe-bridgers', 'Phoebe', 'Bridgers', 'Phoebe Bridgers', '2020-01-01',
        'XXI_CENTURY_MUSIC', '../images/cardi-b-img.png'),
       ...
       ('112C8DD8-346B-426E-B06C-01BBA97DCD09', 'charli-xcx', 'none', 'none', 'Charli XCX', '2020-01-01',
        'XXI_CENTURY_MUSIC', '../images/cardi-b-img.png'),
       ('112C8DD8-346B-426E-B06C-01BBA97DCD10', 'megan-thee-stallion', 'none', 'none', 'Megan Thee Stallion', '2020-01-01',
        'XXI_CENTURY_MUSIC', '../images/cardi-b-img.png'),
       ...
       ('112C8DD8-346B-426E-B06C-01BBA97DCD16', 'run-the-jewels', 'none', 'none', 'Run The Jewels', '2020-01-01',
        'XXI_CENTURY_MUSIC', '../images/cardi-b-img.png'),
       ('112C8DD8-346B-426E-B06C-01BBA97DCD17', 'bruce-springsteen', 'Bruce', 'Springsteen', 'Bruce Springsteen', '2020-01-01',
        'XXI_CENTURY_MUSIC', '../images/cardi-b-img.png'),
