INSERT INTO sotylists (id, url, title, "date", description, spotify_link)
VALUES (1, '2020','20 лучших песен 2020 года', '2020-01-01', 'Откровенный трэп-бэнгер от Cardi B, Perfume Genius и другие.',
...
INSERT INTO compositions (id, title, musician_id, feature, "date")
VALUES (1, 'WAP', 1, '(feat. Megan Thee Stallion)', '2020-01-01'),
       (2, 'Describe', 2, '', '2020-01-01'),
       (3, 'Gaslighter', 3, '', '2020-01-01'),
       (4, 'Anything', 4, '', '2020-01-01'),
       (5, 'Time', 5, '', '2020-01-01'),
       (6, '', null, '', '2020-01-01'),
       (7, '', null, '', '2020-01-01'),
       (8, '', null, '', '2020-01-01'),
